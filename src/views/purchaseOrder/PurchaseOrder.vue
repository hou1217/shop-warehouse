<template>
  <div class="container container_purchase-order">
    <!-- todo 替换为通用组件 -->
    <div class="hd">
      ...
      <div class="manage-btn" @click="turnToOrderManage">
        管理
      </div>
    </div>
    ...
    <div class="footer">
      ...
      <div class="confirm-btn" @click.stop="confirm">
        确认进货({{selectedList.length}})
      </div>
    </div>
...
<style scoped lang="stylus" src="./PurchaseOrder.styl"></style>
